...
export interface Istate {
  ...
  isToShowPlus:boolean
}
const initialState:Istate = {
  settingTimesItem: [
    { id: '0', blink: '3', startTime: dayjs(new Date()).format('hh:mm'), endTime:  dayjs(new Date()).format('hh:mm'), room: 1 },
    { id: '1', blink: '', startTime: dayjs(new Date()).format('hh:mm'), endTime:  dayjs(new Date()).format('hh:mm'), room: 0},
     { id: '2', blink: '', startTime: dayjs(new Date()).format('hh:mm'), endTime:  dayjs(new Date()).format('hh:mm'), room: 5 },
...
const settingTimesSlice = createSlice({
  ...
  reducers: {
   ...
   updateSettingTimesValue:(state,action:PayloadAction<{index:number,value:string,column:keyof LineItemTable}>)=>{
   ...
   setIsToShowPlus:(state,action:PayloadAction<{isToShow:boolean}>)=>{
    state.isToShowPlus=action.payload.isToShow;
   }
  },
});

export const { addSettingTimes,updateSettingTimesValue,setIsToShowPlus} = settingTimesSlice.actions;
