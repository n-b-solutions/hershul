 ...
 */
export declare type IDataLayer = {
 ...
 */
export declare type ICustomEnvironmentParams = {
    /**
 ...
 */
export declare type ISnippetsParams = {
 ...
 */
export declare type ISendToGTM = {
    dataLayerName: string;
    data: object;
};
