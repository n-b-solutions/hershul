 ...
 */
export declare const getDataLayerSnippet: (dataLayer: Pick<IDataLayer, 'dataLayer'>['dataLayer'], dataLayerName?: Pick<IDataLayer, 'dataLayerName'>['dataLayerName']) => Pick<ISnippets, 'gtmDataLayer'>['gtmDataLayer'];
/**
 ...
 */
export declare const getIframeSnippet: (id: Pick<ISnippetsParams, 'id'>['id'], environment?: ICustomEnvironmentParams | undefined, customDomain?: ISnippetsParams['customDomain']) => string;
/**
